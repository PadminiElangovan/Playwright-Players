...
test.describe('Login Page Verification Total 31 scenarios', () => {
  ...
  test.describe('Verify <Scenario> is displayed for login', () => {
    ...
    test('Verify login form header is displayed for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiLoginText'] }, async ({ Given, When, Then, pages }) => { 
    ...
    test('Verify sub text of the header is displayed for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiLoginText'] }, async ({ Given, When, Then, pages }) => { 
      await Given('User is on SweetBalance homepage', null, { pages }); 
      await When('User clicks on Login link', null, { pages }); 
      await Then('User should see "Sign in to your account or create a new one" heading in home page', null, { pages }); 
    });

    test('Verify Continue with Email button is displayed for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiLoginText'] }, async ({ Given, When, Then, pages }) => { 
      await Given('User is on SweetBalance homepage', null, { pages }); 
      await When('User clicks on Login link', null, { pages }); 
      await Then('User should see "Continue with email" heading in home page', null, { pages }); 
    });

    test('Verify Continue with Google button is displayed for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiLoginText'] }, async ({ Given, When, Then, pages }) => { 
      await Given('User is on SweetBalance homepage', null, { pages }); 
      await When('User clicks on Login link', null, { pages }); 
      await Then('User should see "Continue with Google" heading in home page', null, { pages }); 
    });

    test('Verify OR separator is displayed for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiLoginText'] }, async ({ Given, When, Then, pages }) => { 
      await Given('User is on SweetBalance homepage', null, { pages }); 
      await When('User clicks on Login link', null, { pages }); 
      await Then('User should see "OR" heading in home page', null, { pages }); 
    });

    test('Verify Terms and Privacy message is displayed for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiLoginText'] }, async ({ Given, When, Then, pages }) => { 
      await Given('User is on SweetBalance homepage', null, { pages }); 
      await When('User clicks on Login link', null, { pages }); 
  ...
  test.describe('Verify <Scenario> for login', () => {
    ...
    test('Verify presence of close button for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiverification'] }, async ({ Given, When, Then, pages }) => { 
      await Given('User is on SweetBalance homepage', null, { pages }); 
      await When('User clicks on Login link', null, { pages }); 
      await Then('User should see "presence of close button" with "close button at the right corner" in home page', null, { pages }); 
    });

    test('Verify email input field for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiverification'] }, async ({ Given, When, Then, pages }) => { 
      await Given('User is on SweetBalance homepage', null, { pages }); 
      await When('User clicks on Login link', null, { pages }); 
      await Then('User should see "email input field" with "input field to enter email" in home page', null, { pages }); 
    });

    test('Verify placeholder text in email field for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiverification'] }, async ({ Given, When, Then, pages }) => { 
      await Given('User is on SweetBalance homepage', null, { pages }); 
      await When('User clicks on Login link', null, { pages }); 
      await Then('User should see "placeholder text in email field" with "Enter email" in home page', null, { pages }); 
    });

    test('Verify Continue with Email is visible for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiverification'] }, async ({ Given, When, Then, pages }) => { 
      await Given('User is on SweetBalance homepage', null, { pages }); 
      await When('User clicks on Login link', null, { pages }); 
    ...
    test('Verify Continue with Email is enabled for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiverification'] }, async ({ Given, When, Then, pages }) => { 
      await Given('User is on SweetBalance homepage', null, { pages }); 
      await When('User clicks on Login link', null, { pages }); 
    ...
    test('Verify Continue with Google is visible for login', { tag: ['@sweet', '@login', '@ela', '@skiplaunch', '@uiverification'] }, async ({ Given, When, Then, pages }) => { 
      await Given('User is on SweetBalance homepage', null, { pages }); 
      await When('User clicks on Login link', null, { pages }); 
  ...
  test.describe('Verify <Scenario> for registered email', () => {
    ...
    test('Verify email input accepts valid existing email for registered email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@loginpg'] }, async ({ Given, When, Then, pages, testData }) => { 
    ...
    test('Verify email input rejects invalid email format for registered email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@loginpg'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on the login page', null, { pages }); 
      await When('User clicks continue with email button after entering email', null, { pages, testData }); 
      await Then('User should see "email input rejects invalid email format" with "validation error" for login', null, { pages, testData }); 
    });

    test('Verify presence of signin button for registered email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@loginpg'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on the login page', null, { pages }); 
      await When('User clicks continue with email button after entering email', null, { pages, testData }); 
      await Then('User should see "presence of signin button" with "Sign in button" for login', null, { pages, testData }); 
    });

    test('Verify sub text in login for registered email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@loginpg'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on the login page', null, { pages }); 
      await When('User clicks continue with email button after entering email', null, { pages, testData }); 
      await Then('User should see "sub text in login" with "email id  in sub text" for login', null, { pages, testData }); 
    });

    test('Verify presence of forgot password link for registered email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@loginpg'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on the login page', null, { pages }); 
      await When('User clicks continue with email button after entering email', null, { pages, testData }); 
      await Then('User should see "presence of forgot password link" with "Forgot password link" for login', null, { pages, testData }); 
    });

    test('Verify presence of placeholder in password field for registered email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@loginpg'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on the login page', null, { pages }); 
      await When('User clicks continue with email button after entering email', null, { pages, testData }); 
  ...
  test('Password input accepts valid existing user', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@navtohomepg', '@Login_19'] }, async ({ Given, When, Then, pages }) => { 
    await Given('User is on the login page', null, { pages }); 
  ...
  test.describe('Verify <Scenario> for new user email', () => {
    ...
    test('Verify email input accepts valid new email for new user email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@profileform'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on the login page', null, { pages }); 
    ...
    test('Verify Full Name field is visible for new user email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@profileform'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on the login page', null, { pages }); 
      await When('User clicks continue with email button after entering new email', null, { pages }); 
      await Then('User should see "Full Name field is visible" with "Full Name" for profile form', null, { pages, testData }); 
    });

    test('Verify Username field is visible for new user email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@profileform'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on the login page', null, { pages }); 
      await When('User clicks continue with email button after entering new email', null, { pages }); 
      await Then('User should see "Username field is visible" with "Username" for profile form', null, { pages, testData }); 
    });

    test('Verify Password field is visible for new user email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@profileform'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on the login page', null, { pages }); 
      await When('User clicks continue with email button after entering new email', null, { pages }); 
      await Then('User should see "Password field is visible" with "Password" for profile form', null, { pages, testData }); 
    });

    test('Verify Terms & Conditions checkbox is visible for new user email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@profileform'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on the login page', null, { pages }); 
      await When('User clicks continue with email button after entering new email', null, { pages }); 
    ...
    test('Verify Create Account button is disabled initially for new user email', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@profileform'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on the login page', null, { pages }); 
      await When('User clicks continue with email button after entering new email', null, { pages }); 
  ...
  test('Create Account button is enabled after valid input', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@navtohomepg', '@Login_26'] }, async ({ Given, When, Then, pages, testData }) => { 
  ...
  test.describe('Verify <Scenario> in complete profile form', () => {
    ...
    test('Verify Create account form with invalid Fullname in complete profile form', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@completeprofileform'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on complete profile form page', null, { pages, testData }); 
    ...
    test('Verify Create account form with invalid UserNmae in complete profile form', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@completeprofileform'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on complete profile form page', null, { pages, testData }); 
      await When('User clicks create account button after filling all fields', null, { pages, testData }); 
  ...
  test.describe('Verify <Scenario> in complete profile form valid', () => {
    ...
    test('Verify Create account form with valid data in complete profile form valid', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@completeprofileformValid'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on complete profile form page', null, { pages, testData }); 
    ...
    test('Verify presence of Upload Blood Report button in complete profile form valid', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@completeprofileformValid'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on complete profile form page', null, { pages, testData }); 
      await When('User clicks create account button after filling all valid values', null, { pages, testData }); 
      await Then('User should see "upload blood report" in complete profile form', null, { pages, testData }); 
    });

    test('Verify presence of Step Through Onboarding button in complete profile form valid', { tag: ['@sweet', '@login', '@ela', '@skiplogin', '@completeprofileformValid'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on complete profile form page', null, { pages, testData }); 
      await When('User clicks create account button after filling all valid values', null, { pages, testData }); 
