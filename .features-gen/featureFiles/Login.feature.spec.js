...
test.describe('Login Page Verification', () => {
  ...
  test.describe('Verify <Scenario> in complete profile form valid', () => {
    ...
    test('Verify Create account form  with valid data in complete profile form valid', { tag: ['@sweet', '@login', '@skiplogin', '@completeprofileformValid'] }, async ({ Given, When, Then, pages, testData }) => { 
      await Given('User is on complete profile form page with new email', null, { pages }); 
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":196,"pickleLine":113,"tags":["@sweet","@login","@skiplogin","@completeprofileformValid"],"steps":[{"pwStepLine":197,"gherkinStepLine":107,"keywordType":"Context","textWithKeyword":"Given User is on complete profile form page with new email","stepMatchArguments":[]},{"pwStepLine":198,"gherkinStepLine":108,"keywordType":"Action","textWithKeyword":"When User clicks create account button after filling all valid values","stepMatchArguments":[]},{"pwStepLine":199,"gherkinStepLine":109,"keywordType":"Outcome","textWithKeyword":"Then User should see \"upload blood report\" in complete profile form","stepMatchArguments":[{"group":{"start":16,"value":"\"upload blood report\"","children":[{"start":17,"value":"upload blood report","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":202,"pickleLine":114,"tags":["@sweet","@login","@skiplogin","@completeprofileformValid"],"steps":[{"pwStepLine":203,"gherkinStepLine":107,"keywordType":"Context","textWithKeyword":"Given User is on complete profile form page with new email","stepMatchArguments":[]},{"pwStepLine":204,"gherkinStepLine":108,"keywordType":"Action","textWithKeyword":"When User clicks create account button after filling all valid values","stepMatchArguments":[]},{"pwStepLine":205,"gherkinStepLine":109,"keywordType":"Outcome","textWithKeyword":"Then User should see \"upload blood report\" in complete profile form","stepMatchArguments":[{"group":{"start":16,"value":"\"upload blood report\"","children":[{"start":17,"value":"upload blood report","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":208,"pickleLine":115,"tags":["@sweet","@login","@skiplogin","@completeprofileformValid"],"steps":[{"pwStepLine":209,"gherkinStepLine":107,"keywordType":"Context","textWithKeyword":"Given User is on complete profile form page with new email","stepMatchArguments":[]},{"pwStepLine":210,"gherkinStepLine":108,"keywordType":"Action","textWithKeyword":"When User clicks create account button after filling all valid values","stepMatchArguments":[]},{"pwStepLine":211,"gherkinStepLine":109,"keywordType":"Outcome","textWithKeyword":"Then User should see \"Step Through Onboarding button\" in complete profile form","stepMatchArguments":[{"group":{"start":16,"value":"\"Step Through Onboarding button\"","children":[{"start":17,"value":"Step Through Onboarding button","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
]; // bdd-data-end